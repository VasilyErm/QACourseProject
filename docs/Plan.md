...
- В поле "CVC/CVV" ввсети валидное значение в формате "ххх".
...
- В поле "Месяц" ввести валидное значение в формате "хх".
- В поле "Год" ввести валидное значение в формате "хх".
- В поле "Владелец" ввсети не валидное значение из одной буквы на кириллице или латинице.
- В поле "CVC/CVV" ввсети валидное значение в формате "ххх".
- Нажать кнопку "Продолжить".
...
### Сценарий 30. Покупка в кредит APPROVED картой с не существуещем месяцем:
- Нажать кнопку "Купить в кредит".
- В поле "Номер карты" ввести APPROVED карту "1111 2222 3333 4444".
- В поле "Месяц" ввести не существуещий месяц в формате "хх".
- В поле "Год" ввести текущий год в формате "хх".
